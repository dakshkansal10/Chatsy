...
import cloudinary from "../lib/utils.js";
...
export const signup = async (req,res) => {
    ...
    try{
        ...
        await newUser.save(); // ✅ must be called
    if(newUser){
...
export const login = async (req,res) => {
    ...
    try {
        ...
        res.status(500).json({message: "Invalid Server message authcontroller.js"});
...
export const updateProfile = async (req,res) => {
    try {
        ...
        console.log("profilePic:", profilePic?.substring(0, 30)); // just show the start
